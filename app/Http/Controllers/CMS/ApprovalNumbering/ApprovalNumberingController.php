...
namespace App\Http\Controllers\CMS\ApprovalNumbering;
...
class ApprovalNumberingController extends Controller
{
    public function Home(Request $request)
    {
        ...
        $DataTable = [
            ...
            'options' => $options,
            'heads' => [
                (object)['name' => 'tgl masuk', 'label' => 'TANGGAL'],
        ...
        return view('app.approval_numbering.home.index', $ParseData);
    }
}
