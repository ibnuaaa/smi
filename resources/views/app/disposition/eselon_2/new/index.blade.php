    ...
    <div class="container-fluid container-fixed-lg">
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Disposisi Surat (ESELON 2 (PIMPINAN PRATAMA) KE ESELON 3)</div><br>
            </div>
            <div class="card-body">
                                ...
                                <table class="tablea table-condenseda table-borderlessa text-dark" border="0" style="width:100%;">
                                    <tbody class="">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" "><i>(Otomatis setelah disposisi)</i></td>
                                            <td>&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>&nbsp;</td>
                                        ...
                                        <tr>
                                                ...
                                                <br />
                                                    ...
                                                    @foreach ($child_positions as $key => $val)
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label" for="chk{{$key}}">{{$val->shortname}}</label>
                                                        </div>
                                                    @endforeach
                                            ...
                                            <td class="p-l-50" colspan="2" style="vertical-align:top;">
