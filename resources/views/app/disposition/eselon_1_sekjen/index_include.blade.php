                                <table class="disposition text-dark color-black font-surat font-size-surat line-height-surat tbl" style="width:100%;" border="0">
                                    <tbody class="">
                                        <tr>
                                            <td class="b-b text-center p-b-10" colspan="4">
                                                <div style="width:80px;float:left;padding-left:1cm;">
                                                    <img src="assets/img/logo-kemendagri-small.png" width="80px" />
                                                </div>
                                                <div style="float:left; margin-left: 140px;">
                                                    <span style="text-align: center">
                                                        ...
                                                        <span style="font-size:16px !important;">SEKRETARIS JENDERAL</span>
                                                    </span>
                                                </div>
