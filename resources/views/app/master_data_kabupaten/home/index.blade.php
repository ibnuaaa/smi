    ...
    <div class="container-fluid container-fixed-lg">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/kabupaten/new') }}"><i class="fas fa-plus"></i> Create</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
        ...
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Data Kabupaten / Kota</div><br>
            </div>
            <div class="card-body">
                   ...
                   <table class="table table-hover table-condensed">
                      ...
                      <tbody>
                         <tr>
                            ...
                            <td class="v-align-middle">
                               <div class="btn-group">
                                  <a href="/kabupaten/1" class="btn btn-info"><i class="fas fa-eye"></i></a>
                                  <a href="/kabupaten/edit/1" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
