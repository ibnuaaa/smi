...
@section('content')
    <div class="jumbotron" data-pages="parallax">
        <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/application/notverified') }}">Not Verify</a></li>
                    <li class="breadcrumb-item active">Detail Not Verify</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-4">
                <div class="card card-default card-action">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/application/not-verified-pdf/' . $enoreg) }}" target="_blank" class="btn btn-block btn-success btn-cons"><i class="fas fa-download"></i> Download PDF</a>
                    </div>
                </div>
            </div>
        </div>
