    ...
    <div class="container-fluid container-fixed-lg">
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">SURAT TUGAS</div><br>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        @if (!empty(env('ESIGN_USE')) && env('ESIGN_USE') == 'Y' && !empty($data->signed_pdf_path))
                            <iframe src="https://{{ env('APP_DOMAIN') }}/pdf/{{ str_replace('/','0!0', $config['esign_url'] . $data->signed_pdf_path) }}" width="100%" height="600px"></iframe>
                        @else
