    ...
    <div class="container-fluid container-fixed-lg">
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Approval Surat</div><br>
            </div>
            <div class="card-body">
                        ...
                        <tr>
                            <td class="v-align-top " >
                                <p style="white-space: normal;">
                                    {{ dateIndo($item->my_approval->created_at) }} <br />
                                    {{ timeIndo($item->my_approval->created_at) }}
                                </p>
                            </td>
                            <td class="v-align-top ">
                            ...
                            <td class="v-align-top ">
                                <label class="btn btn-{{ config('app.mail_approval_color.' . $item->approval_status) }} btn-xs">
                                    {{ config('app.mail_approval_status.' . $item->approval_status) }}
                                </label>
                            </td>

                            <td class="v-align-top">
                                <div class="btn-group">
                                    <a href="{{ url('surat/preview/' . $item->id. '/approval') }}" class="btn btn-xs btn-success btn-table-action">
                                        Preview
                                    </a>
                                </div>
                            </td>
