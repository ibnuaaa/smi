    ...
    <div class="container-fluid container-fixed-lg">
        <div class="card card-white">
            <div class="card-header ">
                <div class="card-title">Jenis Dokumen</div><br>
            </div>
            <div class="card-body">
                         ...
                         <div class="row">
                               ...
                               <div class="blade-datatable-sort">
                                  ...
                                  <div class="dropdown dropdown-default">
                                     ...
                                     <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/sektor?sektor-table-take=10">10</a>
                                        <a class="dropdown-item" href="/sektor?sektor-table-take=25">25</a>
                                        <a class="dropdown-item" href="/sektor?sektor-table-take=50">50</a>
                                        <a class="dropdown-item" href="/sektor?sektor-table-take=100">100</a>
                                     </div>
                                  </div>
                                  <p>Entries</p>
                               </div>
                            ...
                            <div class="col-4">
                               ...
                               <div class="input-group">
                                  <input  name="sektor-table-filter_search"
                   ...
                   <table class="table table-hover table-condensed">
                      ...
                      <tbody>
                         <tr>
                            ...
                            <td class="v-align-middle">
                               <div class="btn-group">
                                  <a href="/jenis_dokumen/1" class="btn btn-info"><i class="fas fa-eye"></i></a>&nbsp;
                         ...
                         <div class="blade-datatable-paginate">
                            <ul class="row" style="list-style: none;">
                               ...
                               <li class="paginate_button active">
                                  <a href="?sektor-table-page=1">1</a>
                               </li>
...
@section('script')
    @include('app.sektor.home.scripts.index')
@endsection
