                    ...
                    <div class="card-body">
                        <form autocomplete="off" id="editMailClassificationForm">
                            <div class="form-group form-group-default required ">
                                ...
                                <input name="code" value="{{ $data['code'] }}" class="form-control" type="text" required>
                            </div>
                            <div class="form-group form-group-default required ">
            ...
            <div class="col-3">
                <div class="card card-default card-action">
                    <div class="card-body">
                        ...
                        <a href="{{ UrlPrevious(url('/mail_classification')) }}" class="btn btn-block btn-primary btn-cons m-b-10">
...
@section('formValidationScript')
    @include('app.mail_classification.edit.scripts.form')
@endsection
