                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <ul class="navbar-nav d-flex flex-row">
                                <li class="nav-item">
                                    <a href="{{ url('/mail_classification/new') }}"><i class="fas fa-plus"></i> Create</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-4">
                ...
                @component('components.table', ['data' => $data, 'props' => []])
                    ...
                    @scopedslot('record', ($item, $props))
                        <tr>
                            ...
                            <td class="v-align-middle">
                                <div class="btn-group">
                                    <a href="{{ url('/mail_classification/edit/'.$item->id) }}" class="btn btn-success btn-xs">Edit</a>
                                    <a href="#modalDelete" data-toggle="modal" data-record-id="{{$item->id}}" data-record-name="{{$item->name}}" class="btn btn-danger btn-xs">Delete</a>
                                </div>
                            </td>
                        </tr>
                    @endscopedslot
...
@section('script')
    @include('app.mail_classification.home.scripts.index')
@endsection
