        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="card card-default card-action">
                    <div class="card-body">
                        <button data-url-next="{{ UrlPrevious(url('/kecamatan')) }}" class="saveAction btn btn-block btn-success btn-cons m-b-10">
                            <i class="fas fa-save"></i>
                            &nbsp; Save
                        </button>
                        <a href="{{ url('/master_data_pemda') }}" class="btn btn-block btn-danger btn-cons m-b-10"><i class="fas fa-arrow-left"></i> &nbsp;Cancel</a>
                    </div>
                </div>
            </div>
        </div>
